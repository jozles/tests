...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN =     "ton adresse mail gmail codée base64";
        const char* EMAILBASE64_PASSWORD =  "ton mot de passe gmail codé base64";
        const char* FROM =                  "lucieliu66@gmail.com";
