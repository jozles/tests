 ...
 *      AwaitSMTPResponse(client, "220")
 *  2)  client.println("HELO friend")
 *      AwaitSMTPResponse(client, "250")
 *  3)  client.println("AUTH LOGIN")
 *      AwaitSMTPResponse(client)    
 *  4)  client.println(b64Login)
 *      AwaitSMTPResponse(client)
 *  5)  client.println(b64Pwd)
 *      AwaitSMTPResponse(client, "235")
 *  6)  String mailFrom = "MAIL FROM: <" + String(from) + '>'      
 *      client.println(mailFrom)
 *      AwaitSMTPResponse(client)
 *  7)  String rcpt = "RCPT TO: <" + to + '>'
 *      client.println(rcpt)
 *      AwaitSMTPResponse(client)
 *  8)  client.println("DATA");
 *      AwaitSMTPResponse(client, "354")
 *  9)  client.println("From: <" + String(FROM) + '>')
 *      client.println("To: <" + to + '>')
 * 10)  client.print("Subject: ")
 *      client.println(_subject)
 * 11)  client.println("Mime-Version: 1.0")
 ...
 *      client.println(".")
 *      AwaitSMTPResponse(client, "250")
 * 12)  client.println("QUIT")
 *      AwaitSMTPResponse(client, "221")
 */
