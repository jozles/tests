...
{
  mylcd.fillScreen(BLACK);delay(2500);  
  mylcd.fillScreen(RED);delay(2500); 
  mylcd.fillScreen(GREEN);delay(2500); 
  mylcd.fillScreen(BLUE);delay(2500); 
  mylcd.fillScreen(BLACK);delay(2500);
  
  
    mylcd.fillScreen(TFT_RED);delay(2000);
    mylcd.fillScreen(TFT_GREEN);delay(2000);
    mylcd.fillScreen(TFT_BLUE);delay(2000); 
}
...
{
  if(cnt++>2){
    Serial.println("done");mylcd.fillScreen(WHITE);delay(500);
    while(1){digitalWrite(LEDR,0);delay(100);digitalWrite(LEDR,1);delay(1000);}}
  mylcd.setRotation(0);
  fill_screen_test();
  delay(500);
  text_test();
